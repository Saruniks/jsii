...
impl JsiiClient {
    ...
    /// Initialize handshake with jsii runtime
    pub async fn handshake(&mut self) -> Result<HandshakeResponse> {
    ...
    /// Load a jsii assembly
    pub async fn load(&mut self, name: String, version: String, tarball: String) -> Result<()> {
    ...
    pub async fn get(&mut self, objref: Value, property: String) -> Result<GetResponse> {
    ...
    pub async fn set(&mut self, objref: Value, property: String, value: Value) -> Result<()> {
...
/// Global jsii client instance (for simple API)
static mut GLOBAL_CLIENT: Option<Arc<Mutex<JsiiClient>>> = None;

/// Initialize the global jsii client
pub async fn init() -> Result<()> {
    let client = JsiiClient::new()?;
...
/// Get a reference to the global jsii client
